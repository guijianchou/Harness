...
- The Core regression test project (`tests/Harness.Core.Tests`, 24 tests) and the Windows CI workflow are restored; the repository guardrail now requires the test project instead of forbidding it.
...
| System Tray | Configurable minimize/close-to-tray behavior with Open Harness, Reload, View Logs, Compact Mode, Settings, and Exit actions |
