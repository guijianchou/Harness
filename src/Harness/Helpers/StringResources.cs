...
public static class StringResources
{
    ...
    public static string SettingsSystemTray => Get("SettingsSystemTray");
    public static string SettingsSystemTrayDescription => Get("SettingsSystemTrayDescription");
    public static string SettingsAutoRefresh => Get("SettingsAutoRefresh");
    public static string SettingsAutoRefreshDescription => Get("SettingsAutoRefreshDescription");
