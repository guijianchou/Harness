...
{
    private const string StopInjectionResourceName = "Harness.Services.WebViewCommands.StopInjection.js";
    private const string AbortRunResourceName = "Harness.Services.WebViewCommands.AbortRun.js";
