...
{
    private const string WindowClassPrefix = "Harness.TrayIcon.";
    ...
    private void ShowContextMenu()
    {
        ...
        try
        {
            ...
            AppendMenu(menu, MenuFlags.String, MenuOpenApp, _menuStrings.OpenLabel);
    ...
    {
        var tooltip = $"Harness - {_statusText}";
