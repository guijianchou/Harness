...
public partial class WebViewService : IDiagnosticWebViewSession, IDisposable
{
    ...
    private volatile bool _autoRefresh = true;
    ...
    /// <summary>
    /// Gets whether automatic navigation recovery and heartbeat refresh are enabled.
    /// </summary>
    public bool AutoRefreshEnabled => _autoRefresh;

    /// <summary>
    /// Applies the automatic refresh preference at runtime.
    /// </summary>
