...
/// Log files are stored in %LOCALAPPDATA%\Harness\logs\ and rotated daily.
/// </summary>
public class LoggingService : IAppLogger
{
    private static readonly TimeSpan LogRetention = TimeSpan.FromDays(14);
    private static readonly string LogFolder =
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Harness", "logs");
    ...
    public string CurrentLogFilePath =>
        Path.Combine(LogFolder, $"harness-{DateTime.UtcNow:yyyy-MM-dd}.log");
